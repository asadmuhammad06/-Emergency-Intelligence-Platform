...
export async function fetchCityIntel(city, signal) {
  ...
  const requests = [
    fetchJson(`https://api.open-meteo.com/v1/forecast?latitude=${city.lat}&longitude=${city.lon}&current=temperature_2m,precipitation,weathercode&hourly=precipitation`, signal),

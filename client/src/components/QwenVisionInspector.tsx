  ...
  return (
    <div className={`bg-[#080d19] text-slate-100 font-['Plus_Jakarta_Sans'] ${
      standalone
        ...
        : 'rounded-2xl border border-cyan-500/40 p-4 sm:p-5 shadow-[0_0_40px_rgba(6,182,212,0.15)] my-3'
    }`}>
      <div className={`w-full ${standalone ? 'max-w-4xl max-h-[92vh] overflow-y-auto bg-[#0b1329] border border-cyan-500/50 rounded-2xl p-5 sm:p-6 shadow-[0_0_60px_rgba(6,182,212,0.3)]' : ''}`}>
        
        {/* Header Badge */}
        <div className="flex items-center justify-between border-b border-cyan-900/60 pb-3 mb-4">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-cyan-950 border border-cyan-500/60 text-cyan-400 shadow-[0_0_20px_rgba(6,182,212,0.4)]">
              ...
              return (
                <button
                  ...
                  className={`text-left p-2.5 rounded-xl border transition-all flex flex-col justify-between ${
                    isSelected
                      ? 'bg-cyan-950/70 border-cyan-400 text-white shadow-[0_0_15px_rgba(6,182,212,0.3)]'

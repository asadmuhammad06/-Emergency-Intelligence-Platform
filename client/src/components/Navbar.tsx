...
export const Navbar: React.FC<NavbarProps> = React.memo(({
  ...
  return (
    <header className="h-14 w-full bg-[#0b0f1c] border-b border-white/[0.06] px-1.5 sm:px-3 lg:px-5 flex items-center justify-between gap-1 sm:gap-2 select-none sticky top-0 z-50 shadow-[0_2px_20px_rgba(0,0,0,0.6)]">
      ...
      {/* ── CENTER: All 5 Navigation Tabs (Always 100% visible, never pushed inside) ── */}
      <nav className="flex items-center gap-0.5 sm:gap-1 bg-slate-950/80 border border-white/[0.08] p-0.5 sm:p-1 rounded-xl shadow-[inset_0_1px_3px_rgba(0,0,0,0.5)] shrink-0 flex-nowrap">
        {tabs.map(tab => {
          const Icon = tab.icon;
